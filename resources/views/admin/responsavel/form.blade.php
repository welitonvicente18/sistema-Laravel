<!-- <form action="{{ route('responsavel.store') }}" method="POST" class="row mt-4">
    @csrf
    @method('POST') -->
...
<div class="row mt-3">
    <div class="col-12">
        <!-- <span type="submit" class="btn btn-primary">@if(isset($uses)) Atualizar @else Cadastrar @endif</span> -->
        <span type="submit" id="inserir" class="btn btn-primary">Inserir</span>
    </div>
</div>
