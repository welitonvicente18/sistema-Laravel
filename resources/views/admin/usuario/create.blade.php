...
@section('section') @if(isset($uses)) <span class="text-laranja-2">Editar</span> {{$uses->name}} @else Novo Responsável/Aluno(a) @endif @endsection
        ...
        <form action="{{ route('user.update', $uses->id) }}" method="POST" class="mt-1">
            ...
            <form action="{{ route('user.store') }}" method="POST" class="mt-1">
                ...
                <div class="row">
                    ...
                    <!-- div que é inserido outros responsáveis -->
                    <div id="responsavel-list"></div>
